...
int main()
{
  ...
  while(turnend1 == 1)//turn if player 1 started
  {
    LL ll;
    int pot = 0;
    int fold = 0;
  ...
  while (turnend2 == 1)
  {
    ...
    while(run)//player 2 turn 1
    {
      ...
      cout<<"----------------------------------------------------------------------------------"<<endl;
      cout<<" Player 1 its your turn choose what you would like to do."<<endl;
      cout<<" Player 2 made a bet of "<<v<<" chips and has "<<chips2<<" chips.";
      cout<<" The pot is now "<<pot<<" "<<endl<<endl;

      cout<<" Player 1 you have "<<chips1<<endl<<endl;
      cout<<" 1. Look at cards"<<endl;
      cout<<" 2. Call"<<endl;
      cout<<" 3. Raise"<<endl;
      cout<<" 4. Fold"<<endl;
      ...
      switch (choice)
      {
        ...
        case '2'://player 2 is calling first players bet
          cout<<endl<<endl<<endl<<endl<<endl<<endl<<endl<<endl;
          if(chips1 <= v && chips1 != 0){
            chips2 = chips2 + (v - chips1);
            pot = pot + chips1;
            pot = pot - (v - chips1);
            chips1 = 0;
            cout<<" Player 2 has "<<chips2<<endl;
            cout<<" Player 1 is ALL INN!!!"<<endl;
            cout<<" Pot is "<<pot<<endl;
            fold = 3;
            run = false;
            ...
            cout<<" Player 1 is already out of Chips"<<endl;
            fold = 3;
            run = false;
            break;
          }
        ...
        case '3'://Raise
          ...
          pot = pot + v;
          cout<<"----------------------------------------------------------------------------------"<<endl;
          cout<<" Player 2 would you like to call, fold, or reraise?"<<endl;
          cout<<" Pot is now "<<pot<<" and it's "<<v<<" chips to call"<<endl;
          cout<<" 1. Call"<<endl;
          cout<<" 2. ReRaise"<<endl;
          cout<<" 3. Fold"<<endl;
          ...
          if(t == 1){
            ...
            cout<<endl<<endl;
            cout<<"----------------------------------------------------------------------------------"<<endl;
            cout<<" Player 1 would you like to call, fold?"<<endl;
            cout<<" 1. Call"<<endl;
            cout<<" 2. Fold"<<endl;
            cin >> x;
            if(x==1){
